...
public class GenreVO {
	private int gmno, gnum, mnum, gno, cnt, posno, mno;
	private String name;
	
	private int  year, hour, platform1, platform2, platform3, rating;
	public int getYear() {
		return year;
	}
	...
	private String title, director, actor1, actor2, actor3, genre, plot, music, url, age_grade;
	...
	public String toString() {
		return "GenreVO : gmno=" + gmno + ", gnum=" + gnum + ", mnum=" + mnum + ", gno=" + gno + ", cnt=" + cnt
				+ ", name=" + name;
	}
