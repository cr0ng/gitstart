...
<script src="/project/assets/js/jquery-3.6.0.min.js"></script>
                        ...
                        <div class="row justify-content-center">
                            <div class="col-xl-8 col-lg-11 col-md-12">
                                <div class="hero__caption hero__caption2 text-center">
                                    <h1 data-animation="bounceIn" data-delay="0.2s">찜한 영화 리스트</h1>
                                </div>
                            </div>
                        </div>
                    </div>          
                ...
                <div class="row">
                	<div class="single-post">
						<div class="feature-img" id="img">
								<img class="img-fluid" src="/project/assets/img/poster/poster100001.jpg"  alt="">
						</div>
                	...
                	<div class="single-post">
						<div class="feature-img" id="img">
								<img class="img-fluid" src="/project/assets/img/poster/poster100002.jpg"  alt="">
						</div>
							<div class="blog_details">
								<a class="d-inline-block" href="blog_details.jsp">
									<h2 style="color: #2d2d2d;">기묘한 가족</h2>
								</a>
								<ul class="blog-info-link mt-3 mb-4">
									<li><a href="#"><i class="fa fa-heart"></i> 찜하기</a></li>
									<li><a href="#"><i class="fa fa-comments"></i> 03 Comments</a></li>
                	...
                	<div class="single-post">
						<div class="feature-img" id="img">
								<img class="img-fluid" src="/project/assets/img/poster/poster100003.jpg" alt="">
						</div>
							<div class="blog_details">
								<a class="d-inline-block" href="blog_details.jsp">
